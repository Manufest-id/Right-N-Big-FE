        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h4 className="text-xl font-bold text-gray-900">Kontak Cepat</h4>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button className="bg-blue-900 text-white px-6 py-3 rounded-lg hover:bg-blue-800 transition-colors flex items-center justify-center space-x-2">
                  <Mail size={20} />
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-blue-900 text-white px-8 py-4 rounded-lg hover:bg-blue-800 transition-colors flex items-center justify-center space-x-2 text-lg font-semibold"
              >
                <Send size={20} />
