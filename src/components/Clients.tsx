        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center p-6 bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl">
              ...
              <div className="text-gray-600 font-semibold">Sesi Konsultasi</div>
            </div>
            <div className="text-center p-6 bg-gradient-to-br from-amber-50 to-yellow-50 rounded-2xl">
              <div
                className="text-4xl lg:text-5xl font-bold mb-2"
          ...
          <div className="relative overflow-hidden mb-12">
            <div className="animate-scroll">
              {[...clients, ...clients].map((client, index) => (
                <div
                  key={index}
                  className="flex-shrink-0 w-40 h-24 bg-white rounded-lg shadow-md flex items-center justify-center hover:shadow-lg transition-shadow duration-300 p-4 xs:mx-2 sm:mx-6 md:mx-10"
                >
                  <img
