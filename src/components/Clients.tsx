...
const Clients = () => {
  ...
  const clients = [
    ...
    { name: "Bank Mandiri Taspen", logo: "/images/clients/mandiri-taspen-logo.png" },
    ...
    { name: "Binus School Simprug", logo: "/images/clients/binus-school-logo.png" },
  ]
        ...
        <div>
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Dipercaya oleh perusahaan-perusahaan dan institusi terkemuka di Indonesia
            </p>
          </div>
