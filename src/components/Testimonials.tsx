  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: "Program coaching dari Right And Big benar-benar mengubah cara pandang saya dalam memimpin perusahaan. Tim kami menjadi lebih solid dan produktivitas meningkat 40% dalam 6 bulan. Ko Tony dan timnya sangat profesional dan berpengalaman.",
      industry: "Teknologi",
    ...
    },
    {
      ...
      rating: 5,
      text: "Sebagai pemilik UMKM, program 'UMKM Naik Kelas' sangat membantu saya mengembangkan bisnis. Omzet naik 3x lipat dan sekarang sudah buka 5 cabang! Terima kasih Right And Big sudah membantu impian saya menjadi kenyataan.",
      industry: "F&B",
