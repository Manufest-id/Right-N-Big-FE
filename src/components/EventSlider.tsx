  ...
  const events = [
    {
      ...
      description: "Workshop intensif untuk mengembangkan kemampuan kepemimpinan yang efektif di era digital modern",
    },
    {
      id: 2,
      ...
      description: "Program komprehensif untuk mengembangkan UMKM menjadi bisnis yang lebih besar dan berkelanjutan",
    },
    {
      id: 3,
      ...
      description: "Membangun personal brand yang kuat untuk kesuksesan karir dan bisnis di era digital",
    },
  ]
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Event Terdekat</h2>
          <p className="text-xl text-gray-600">
            Jangan lewatkan kesempatan untuk bergabung dengan program terbaru kami
          </p>
        </div>
          ...
          <div className="flex justify-center space-x-2 mt-6">
            {events.map((_, index) => (
              <button
                ...
                style={{
                  backgroundColor: index === currentSlide ? "#02A345" : "#d1d5db",
                }}
              />
            ))}
          </div>
