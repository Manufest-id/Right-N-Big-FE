            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-lg lg:text-xl">
                <p className="text-xl text-gray-600 leading-relaxed">
                  <span className="text-[#1c5739] font-semibold">
                    We build{" "}
                  </span>
                  <span className="text-[#9b4702] font-bold">BUSINESS</span>{" "}
                  <span className="text-[#1c5739] font-semibold">through </span>
                  <span className="text-[#9b4702] font-bold">PEOPLE</span>{" "}
                  <span className="text-[#1c5739] font-semibold">
                    and build
                  </span>{" "}
                  <span className="text-[#9b4702] font-bold">PEOPLE</span>{" "}
